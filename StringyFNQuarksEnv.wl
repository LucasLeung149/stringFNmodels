...
(* ::Title:: *)
(*StringyFNQuarksEnv: RL/GA Environment for Froggatt-Nielsen-type string model building*)
...
BeginPackage["StringyFNQuarksEnv`"];
...
StringyFNQuarksEnv::usage="\[FilledSmallSquare]  This package realises a GA and RL environment for stringy Froggatt-Nielsen (heterotic line bundle) models.\n"<>
"\[FilledSmallSquare]  Basic parameters of the environment are defined in Options[StringyFNQuarksEnv], including the number of singlets, the number of U(1)s, etc.\n"<>
"\[FilledSmallSquare]  For more information about the options type ?StringyFNQuarksEnvOpts.\n"<>
...
"\[FilledSmallSquare]  Type ?StringyFNQuarksEnvAuxModules for more information on the auxiliary modules.\n"<>
...
"\[FilledSmallSquare]  The basic guide of how to use the enviroment can be found by typing ?StringyFNQuarksEnvHowtoUse.\n"<>
"\[FilledSmallSquare]  Details of the main modules can be found by typing ?StringyFNQuarksEnvModules.";
...
StringyFNQuarksEnvOpts::usage="\[FilledSmallSquare]  Options[StringyFNQuarksEnv] gives the global environment options for the package.\n"<>
"\[FilledSmallSquare]  For global environment settings type ?StringyFNQuarksEnvOptsGlobal for details.\n"<>
"\[FilledSmallSquare]  For fitness factors settings type ?StringyFNQuarksEnvOptsFitness for details.\n"<>
"\[FilledSmallSquare]  For SM Quantities type ?StringyFNQuarksEnvOptsSM for details.";

StringyFNQuarksEnvOptsGlobal::usage=" Global environment options:\n"<>
...
"  \[FilledVerySmallSquare]  \"numOfO1Coeff\" - The number of O1 coefficients generated in the Global variable StringyFNQuarksEnv`O1CLst at the start of the code.\n"<>
...
StringyFNQuarksEnvOptsFitness::usage=" Fitness options:\n"<>
...
StringyFNQuarksEnvOptsSM::usage=" SM Quantities (Data):\n"<>
...
StringyFNQuarksEnvAuxModules::usage="List of Modules (type ?$$Modules for details):\n"<>
...
StringyFNQuarksEnvModules::usage="Below is a list of the main modules.\n"<>
...
StringyFNQuarksEnvHowtoUse::usage=" This HowtoUse Guide outlines the basic elements of the system. \n"<>
...
"\[FilledSmallSquare]  See ?StringyFNQuarksEnvAuxModules for the individual modules used in the code.";
...
Print[Style[Options[StringyFNQuarksEnv],"Output"]];
...
(* Error - take positive error for now. *)
(* For neutrinos I have simply taken the mass basis for now  (assuming no mixing). The error is the difference between 68 to 95 confidence levels. For \[Nu]_\[Mu] and \[Nu]_\[Tau] I have just put it some value as a place holder for now. *)
(* CKM values are taken from the Particle Data Group. *)
(* PMNS matrix values are taken from the NuFIT.org. The values without SK-atm are taken (?), picking the mean value between the two gien bounds. *)
...
O1coeffvec=RandomChoice[{-1,1},("numOfO1Coeff"/.Options[StringyFNQuarksEnv])]*RandomReal[("O1CoeffRange"/.Options[StringyFNQuarksEnv]),("numOfO1Coeff"/.Options[StringyFNQuarksEnv])];
O1coeffvec
...
If[("fixedCharges"/.Options[StringyFNQuarksEnv]),
dimchargelst=3*2+2*"nSinglet"/.Options[StringyFNQuarksEnv];
,
dimchargelst=3*3+2+2*"nSinglet"/.Options[StringyFNQuarksEnv];
];

(* Code positition of charges in the U(1)s of the MSSM particles and singlet fields *)
If[("fixedCharges"/.Options[StringyFNQuarksEnv]),
chrglstMSSMtemp=RandomInteger[{1,"nU1s"}/.Options[StringyFNQuarksEnv],dimchargelst];
chrglstMSSM=Join[("tenQ"/.Options[StringyFNQuarksEnv]),Take[chrglstMSSMtemp,6],
("fiveBarHiggsQ"/.Options[StringyFNQuarksEnv]),Take[chrglstMSSMtemp,-(2*("nSinglet"/.Options[StringyFNQuarksEnv]))]]
,
chrglstMSSM=RandomInteger[{1,"nU1s"}/.Options[StringyFNQuarksEnv],dimchargelst];
];

(* Code the charges taken by the non-perturbative fields separately. *)
singletchrglst=RandomInteger["\[CapitalPhi]ChargeRange"/.Options[StringyFNQuarksEnv],{"nNonperts","nU1s"}/.Options[StringyFNQuarksEnv]];
...
num\[Phi]bit=("nSinglet"*"bitsfor\[Phi]"+"nNonperts"*"bitsfor\[CapitalPhi]")/.Options[StringyFNQuarksEnv];
\[Phi]VEVstate=Table[RandomInteger[{0,1}],num\[Phi]bit];
(* Now determine the new chargevector for \[Phi]VEVs.*)
\[Phi]VEVsbits=Partition[Take[\[Phi]VEVstate,("nSinglet"*"bitsfor\[Phi]")/.Options[StringyFNQuarksEnv]],"bitsfor\[Phi]"/.Options[StringyFNQuarksEnv]];
\[Phi]VEVsVec=FromDigits[Transpose[\[Phi]VEVsbits],2];
If[\[Phi]VEVsVec==0,\[Phi]VEVsVec={}];
(* Repeat the same for \[CapitalPhi] part. *)
\[CapitalPhi]VEVsbits=Partition[Take[\[Phi]VEVstate,-("nNonperts"*"bitsfor\[CapitalPhi]")/.Options[StringyFNQuarksEnv]],"bitsfor\[CapitalPhi]"/.Options[StringyFNQuarksEnv]];
...
dimchargelst=3*3+2+2*"nSinglet"/.Options[StringyFNQuarksEnv];
dim\[Phi]bits=("nSinglet"+"nNonperts")/.Options[StringyFNQuarksEnv];
...
chrglstMSSM=Table[UnitVector["nU1s",chrglstMSSM[[i]]],{i,dimchargelst}]/.Options[StringyFNQuarksEnv];
\[CapitalPhi]chrglst=Take[state,{dimchargelst+1,dimchargelst+dim\[CapitalPhi]chrgbits}];
\[CapitalPhi]chrglst=Partition[\[CapitalPhi]chrglst,"nU1s"/.Options[StringyFNQuarksEnv]];
...
Hucharges=-Hdcharges;
\[Phi]charges=Take[chrglstMSSM,{12,11+"nSinglet"/.Options[StringyFNQuarksEnv]}]-Take[chrglstMSSM,-"nSinglet"/.Options[StringyFNQuarksEnv]];
...
\[Phi]VEVsbits=Take[\[Phi]VEVlst,("nSinglet")/.Options[StringyFNQuarksEnv]];
\[Phi]VEVsVals=Abs[\[Phi]VEVsbits];
\[Phi]VEVsVec=Map[("\[Phi]VEVmin"/.Options[StringyFNQuarksEnv])*("\[Phi]VEVlogGen"/.Options[StringyFNQuarksEnv])^#&,\[Phi]VEVsVals];

\[CapitalPhi]VEVsbits=Take[\[Phi]VEVlst,-("nNonperts")/.Options[StringyFNQuarksEnv]];
\[CapitalPhi]VEVsVals=Abs[\[CapitalPhi]VEVsbits];
\[CapitalPhi]VEVsVec=Map[("\[CapitalPhi]VEVmin"/.Options[StringyFNQuarksEnv])*("\[CapitalPhi]VEVlogGen"/.Options[StringyFNQuarksEnv])^#&,\[CapitalPhi]VEVsVals];
...
chargemat=Partition[Flatten[Join[Qcharges,dcharges,ucharges,Lcharges,echarges,Hdcharges,Hucharges,\[Phi]charges,\[CapitalPhi]chrglst]],"nU1s"/.Options[StringyFNQuarksEnv]]
...
\[Phi]rules=Table[("BundleModuliFields"/.Options[StringyFNQuarksEnv])[i]->\[Phi]VEVsVec[[i]],{i,1,"nSinglet"/.Options[StringyFNQuarksEnv]}];
\[CapitalPhi]rules=Table[("KahlerEffFields"/.Options[StringyFNQuarksEnv])[i]->\[CapitalPhi]VEVsVec[[i]],{i,1,"nNonperts"/.Options[StringyFNQuarksEnv]}];
...
numperts="nSinglet"/.Options[StringyFNQuarksEnv];
numkahls="nNonperts"/.Options[StringyFNQuarksEnv];
numU1s="nU1s"/.Options[StringyFNQuarksEnv];
...
(* VEVs *)
(*bmlog0="\[Phi]VEVmin"/.Options[StringyFNQuarksEnv];
kmlog0="\[CapitalPhi]VEVmin"/.Options[StringyFNQuarksEnv];
bmloggen="\[Phi]VEVlogGen"/.Options[StringyFNQuarksEnv];
kmloggen="\[CapitalPhi]VEVlogGen"/.Options[StringyFNQuarksEnv];*)
...
(* write the rules *)
\[Phi]rules=Table[("BundleModuliFields"/.Options[StringyFNQuarksEnv])[i]->\[Phi]VEVs[[i]],{i,1,numperts}];
\[CapitalPhi]rules=Table[("KahlerEffFields"/.Options[StringyFNQuarksEnv])[i]->\[CapitalPhi]VEVs[[i]],{i,1,numkahls}];
...
dimVEVs=("nSinglet"+"nNonperts")/.Options[StringyFNQuarksEnv];
VEVlst=Take[stateVec,-dimVEVs];
\[Phi]VEVslst=Take[VEVlst,(("nSinglet")/.Options[StringyFNQuarksEnv])];
\[CapitalPhi]VEVslst=Take[VEVlst,-(("nNonperts")/.Options[StringyFNQuarksEnv])];
...
(* First we find the dimension of the charge vector. *)
dimchargelst=3*3+2+2*"nSinglet"/.Options[StringyFNQuarksEnv];
num=("nU1s"/.Options[StringyFNQuarksEnv])^dimchargelst;
dimension=Ceiling[Log[2,num]];

(* Now add in the dimension for \[CapitalPhi] sector. *)
chargerange="\[CapitalPhi]ChargeRange"/.Options[StringyFNQuarksEnv];
\[CapitalPhi]Dim=(chargerange[[2]]-chargerange[[1]]+1);
\[CapitalPhi]Dim=Log[2,\[CapitalPhi]Dim];
total\[CapitalPhi]dim=\[CapitalPhi]Dim*("nNonperts"/.Options[StringyFNQuarksEnv])*(("nU1s"/.Options[StringyFNQuarksEnv])-1);
dimension=dimension+total\[CapitalPhi]dim;

(* Add in dimension for \[Phi]VEVs. *)
dimVEVbits=("nSinglet"*"bitsfor\[Phi]"+"nNonperts"*"bitsfor\[CapitalPhi]")/.Options[StringyFNQuarksEnv];
...
\[Phi]VEVdim=dim[[3]];
tot\[CapitalPhi]dim=\[CapitalPhi]dim*("nNonperts"/.Options[StringyFNQuarksEnv])*("nU1s"/.Options[StringyFNQuarksEnv]);
MSSMdim=dim[[1]]-tot\[CapitalPhi]dim-\[Phi]VEVdim;

(* \[CapitalPhi] sector. *)
If[("nNonperts"/.Options[StringyFNQuarksEnv])==0,
...
dimchargelst=3*3+2+2*"nSinglet"/.Options[StringyFNQuarksEnv];
MSSMqvec=IntegerDigits[FromDigits[MSSMqvec,2],"nU1s"/.Options[StringyFNQuarksEnv]];
...
\[CapitalPhi]dim=dim[[2]];
\[Phi]VEVdim=dim[[3]];
tot\[CapitalPhi]dim=\[CapitalPhi]dim*("nNonperts"/.Options[StringyFNQuarksEnv])*(("nU1s"/.Options[StringyFNQuarksEnv])-1);
MSSMdim=dim[[1]]-tot\[CapitalPhi]dim-\[Phi]VEVdim;
Max\[CapitalPhi]Charge=-("\[CapitalPhi]ChargeRange"/.Options[StringyFNQuarksEnv])[[1]];
...
lastDigit\[CapitalPhi]QVec=Map[Total,Partition[\[CapitalPhi]chargevec,(("nU1s"/.Options[StringyFNQuarksEnv])-1)]];
lastDigit\[CapitalPhi]QVec=Map[{-#}&,lastDigit\[CapitalPhi]QVec];
\[CapitalPhi]chargevec=Flatten[Flatten[Join[Partition[\[CapitalPhi]chargevec,(("nU1s"/.Options[StringyFNQuarksEnv])-1)],lastDigit\[CapitalPhi]QVec,2]]];
];
...
tenCharge=("tenQ"/.Options[StringyFNQuarksEnv]);
fiveBarHiggsCharge=("fiveBarHiggsQ"/.Options[StringyFNQuarksEnv]);
MSSMqvecnewComb=Join[tenCharge,Take[MSSMqvecnew,6],fiveBarHiggsCharge,Take[MSSMqvecnew,-(2*"nSinglet"/.Options[StringyFNQuarksEnv])]];
...
bits\[Phi]VEVs=Flatten[(Map[PadLeft[IntegerDigits[#,2],("bitsfor\[Phi]"/.Options[StringyFNQuarksEnv])]&,\[Phi]VEVpart])];
bits\[CapitalPhi]VEVs=Flatten[(Map[PadLeft[IntegerDigits[#,2],("bitsfor\[CapitalPhi]"/.Options[StringyFNQuarksEnv])]&,\[CapitalPhi]VEVpart])];
...
numU1=("nU1s"/.Options[StringyFNQuarksEnv]);
...
num\[CapitalPhi]QBitsPer=Ceiling[(Log[(("\[CapitalPhi]ChargeRange"/.Options[StringyFNQuarksEnv])[[2]]-("\[CapitalPhi]ChargeRange"/.Options[StringyFNQuarksEnv])[[1]])]/Log[2])];
...
Fnominus1="nU1s"-1/.Options[StringyFNQuarksEnv];
...
fieldvec=Flatten[Join[Table[("BundleModuliFields"/.Options[StringyFNQuarksEnv])[i],{i,1,"nSinglet"/.Options[StringyFNQuarksEnv]}],Table[("KahlerEffFields"/.Options[StringyFNQuarksEnv])[i],{i,1,"nNonperts"/.Options[StringyFNQuarksEnv]}]]];
...
nFields= "nSinglet"+"nNonperts"/.Options[StringyFNQuarksEnv];
...
fields=Table[("BundleModuliFields"/.Options[StringyFNQuarksEnv])[i],{i,1,nFields,1}];
\[Phi]fields=Take[fields,"nSinglet"/.Options[StringyFNQuarksEnv]];
\[CapitalPhi]fields=Take[fields,-"nNonperts"/.Options[StringyFNQuarksEnv]];

(* Charge matrix reduction to representations of J. *)
nchargevec="nChargeVec"/.Options[StringyFNQuarksEnv];
...
(*powersphi=Tuples[Table[i,{i,0,("DimOp"/.Options[StringyFNQuarksEnv])}],("nSinglet"/.Options[StringyFNQuarksEnv])];
powersphi=Select[powersphi,Total[#]<=("DimOp"/.Options[StringyFNQuarksEnv])&];
powersPhi=Tuples[Table[i,{i,0,("DimOpof\[CapitalPhi]"/.Options[StringyFNQuarksEnv])}],("nNonperts"/.Options[StringyFNQuarksEnv])];
powersPhi=Select[powersPhi,Total[#]<=("DimOpof\[CapitalPhi]"/.Options[StringyFNQuarksEnv])&];
powerslst=Map[Flatten,Tuples[{powersphi,powersPhi}]];
*)
powersphi=Tuples[Table[i,{i,0,("DimOp"/.Options[StringyFNQuarksEnv])}],nFields];
powersphi=Map[Reverse,powersphi];
powersphi=Select[powersphi,Total[Take[#,("nSinglet"/.Options[StringyFNQuarksEnv])]]<=("DimOp"/.Options[StringyFNQuarksEnv])&];
powerslst=Select[powersphi,Total[Take[#,-("nNonperts"/.Options[StringyFNQuarksEnv])]]<=("DimOpof\[CapitalPhi]"/.Options[StringyFNQuarksEnv])&];
...
zeroVecQs},
nSings="nSinglet"/.Options[StringyFNQuarksEnv];
nKahls="nNonperts"/.Options[StringyFNQuarksEnv];
numU1s="nU1s"/.Options[StringyFNQuarksEnv];
singQList=Transpose[Partition[smoduliCharges,nSings]];
maxDim="DimOp"/.Options[StringyFNQuarksEnv];
...
numU1s="nU1s"/.Options[StringyFNQuarksEnv];
singQList=Transpose[Partition[smoduliCharges,nSings]];
dimKahl="DimOpof\[CapitalPhi]"/.Options[StringyFNQuarksEnv];

(* Find correct representation of the KahlCharges *)
nVec="nChargeVec"/.Options[StringyFNQuarksEnv];
...
nSings="nSinglet"/.Options[StringyFNQuarksEnv];
nKahls="nNonperts"/.Options[StringyFNQuarksEnv];
nU1s="nU1s"/.Options[StringyFNQuarksEnv];
...
If[(("MethodGenOps"/.Options[StringyFNQuarksEnv])=="List")||(("MethodGenOps"/.Options[StringyFNQuarksEnv])=="Graph")||(("MethodGenOps"/.Options[StringyFNQuarksEnv])=="Optimal"),

If[("MethodGenOps"/.Options[StringyFNQuarksEnv])=="List",
WIJaOps=FindOpsforWIJaListwith\[Phi]VEVsQsector[statevec];
];
If[("MethodGenOps"/.Options[StringyFNQuarksEnv])=="Graph"||("MethodGenOps"/.Options[StringyFNQuarksEnv])=="Optimal",
...
Scale="VEVsScale"/.Options[StringyFNQuarksEnv];
\[Phi]Fields=Table[("BundleModuliFields"/.Options[StringyFNQuarksEnv])[i],{i,1,"nSinglet"/.Options[StringyFNQuarksEnv]}];
\[CapitalPhi]Fields=Table[("KahlerEffFields"/.Options[StringyFNQuarksEnv])[i],{i,1,"nNonperts"/.Options[StringyFNQuarksEnv]}];
...
\[Phi]VEVsReplaceRule=Table[(\[Phi]Fields[[i]]->\[Phi]VEVsList[[i]]),{i,1,"nSinglet"/.Options[StringyFNQuarksEnv]}];
\[CapitalPhi]VEVsReplaceRule=Table[(\[CapitalPhi]Fields[[i]]->\[CapitalPhi]VEVsList[[i]]),{i,1,"nNonperts"/.Options[StringyFNQuarksEnv]}];
...
YukdLeadList=Flatten[Map[LowestOrderTerms[#,{("VEVsScale"/.Options[StringyFNQuarksEnv])}]&,Flatten[YukdLeadYYt]]];
...
YukDown\[Chi]DiagLeadTerm=LowestOrderOfMonomialListOneVar[DeleteElements[YukDown\[Chi]Diag,{0}],("VEVsScale"/.Options[StringyFNQuarksEnv])];
YukDown\[Chi]LinLeadTerm=LowestOrderOfMonomialListOneVar[DeleteElements[YukDown\[Chi]Lin,{0}],("VEVsScale"/.Options[StringyFNQuarksEnv])];
YukDown\[Chi]ConstLeadTerm=LowestOrderOfMonomialListOneVar[DeleteElements[YukDown\[Chi]Const,{0}],("VEVsScale"/.Options[StringyFNQuarksEnv])];
...
YukDownEigensPowers=Map[Exponent[#,("VEVsScale"/.Options[StringyFNQuarksEnv])]&,YukDownEigens];
(* repeat from Up *)
...
YukUp\[Chi]DiagLeadTerm=LowestOrderOfMonomialListOneVar[DeleteElements[YukUp\[Chi]Diag,{0}],("VEVsScale"/.Options[StringyFNQuarksEnv])];
YukUp\[Chi]LinLeadTerm=LowestOrderOfMonomialListOneVar[DeleteElements[YukUp\[Chi]Lin,{0}],("VEVsScale"/.Options[StringyFNQuarksEnv])];
YukUp\[Chi]ConstLeadTerm=LowestOrderOfMonomialListOneVar[DeleteElements[YukUp\[Chi]Const,{0}],("VEVsScale"/.Options[StringyFNQuarksEnv])];
...
YukUp\[Chi]DiagLeadTermPowers=Exponent[YukUp\[Chi]DiagLeadTerm,("VEVsScale"/.Options[StringyFNQuarksEnv])];
YukUp\[Chi]DiagPowers=Map[Exponent[#,("VEVsScale"/.Options[StringyFNQuarksEnv])]&,YukUp\[Chi]Diag];
YukUpEigensPowers=Map[Exponent[#,("VEVsScale"/.Options[StringyFNQuarksEnv])]&,YukUpEigens];
PosTopEntry=Position[YukUp\[Chi]DiagPowers,YukUp\[Chi]DiagLeadTermPowers][[1]][[1]];
(* Find Pos Down Entry too *)
YukDown\[Chi]DiagLeadTermPowers=Exponent[YukDown\[Chi]DiagLeadTerm,("VEVsScale"/.Options[StringyFNQuarksEnv])];
YukDown\[Chi]DiagPowers=Map[Exponent[#,("VEVsScale"/.Options[StringyFNQuarksEnv])]&,YukDown\[Chi]Diag];
...
usedScale="VEVsScale"/.Options[StringyFNQuarksEnv];
...
numSing="nSinglet"/.Options[StringyFNQuarksEnv];
numKahl="nNonperts"/.Options[StringyFNQuarksEnv];

(* create the ScalesList *)
usedScale="VEVsScale"/.Options[StringyFNQuarksEnv];
\[Phi]Fields=Table[("BundleModuliFields"/.Options[StringyFNQuarksEnv])[i],{i,1,numSing}];
\[CapitalPhi]Fields=Table[("KahlerEffFields"/.Options[StringyFNQuarksEnv])[i],{i,1,numKahl}];
...
ScaleSym="VEVsScale"/.Options[StringyFNQuarksEnv];
\[Epsilon]1=If[massHierarchyAssoc[["mu/mcPow"]]===0,3,
(("mu"/.Options[StringyFNQuarksEnv])[[1]]/("mu"/.Options[StringyFNQuarksEnv])[[2]])^(1/massHierarchyAssoc[["mu/mcPow"]])];
\[Epsilon]2=If[massHierarchyAssoc[["mc/mtPow"]]===0,3,
(("mu"/.Options[StringyFNQuarksEnv])[[2]]/("mu"/.Options[StringyFNQuarksEnv])[[3]])^(1/massHierarchyAssoc[["mc/mtPow"]])];
\[Epsilon]3=If[massHierarchyAssoc[["md/msPow"]]===0,3,
(("md"/.Options[StringyFNQuarksEnv])[[1]]/("md"/.Options[StringyFNQuarksEnv])[[2]])^(1/massHierarchyAssoc[["md/msPow"]])];
\[Epsilon]4=If[massHierarchyAssoc[["ms/mbPow"]]===0,3,
(("md"/.Options[StringyFNQuarksEnv])[[2]]/("md"/.Options[StringyFNQuarksEnv])[[3]])^(1/massHierarchyAssoc[["ms/mbPow"]])];
...
HiggsTopSq=(("mu"/.Options[StringyFNQuarksEnv])[[3]])^2/((mTopScale)^2);
HiggsBottomSq=(("md"/.Options[StringyFNQuarksEnv])[[3]])^2/((mBottomScale*O1CoeffBottom)^2);
BestO1TopSq=HiggsTopSq/(("v"/.Options[StringyFNQuarksEnv])^2-HiggsBottomSq);
...
extraFactors="fitTextFac"/.Options[StringyFNQuarksEnv];
...
raggedOplist=Oplist/.Table[("BundleModuliFields"/.Options[StringyFNQuarksEnv])[i]->a,{i,1,"nSinglet"/.Options[StringyFNQuarksEnv],1}]/.Table[("KahlerEffFields"/.Options[StringyFNQuarksEnv])[i]->a,{i,1,"nNonperts"/.Options[StringyFNQuarksEnv],1}];
...
{O1RangeMin,O1RangeMax}="O1CoeffRange"/.Options[StringyFNQuarksEnv];
tol=10^(-10);
...
vuvalmax=("vumax"/.Options[StringyFNQuarksEnv]);
If[Yudec[[2]][[1]][[1]]==0,
vuval=vuvalmax,
vuval=(("mu"/.Options[StringyFNQuarksEnv])[[3]])/(Yudec[[2]][[1]][[1]]);
If[vuval<vuvalmax,vuval,vuval=vuvalmax];
];
HuRule=<|"Hu"->vuval|>;

(* We might as well just find vd using the bottom quark. *)
vdvalmax=("vdmax"/.Options[StringyFNQuarksEnv]);
If[Yddec[[2]][[1]][[1]]==0,
vdval=vdvalmax,
vdval=(("md"/.Options[StringyFNQuarksEnv])[[3]])/(Yddec[[2]][[1]][[1]]);
...
maxLog="MaxLogPower"/.Options[StringyFNQuarksEnv];
If[numerator==0,
result=maxLog;
,
...
HiggsSM=("HVEV"/.mass)*("MplinGeV"/.Options[StringyFNQuarksEnv]);
HiggsBound=("HiggsBound"/.Options[StringyFNQuarksEnv]);
HiggsFactor=("HiggsFitScaleFactor"/.Options[StringyFNQuarksEnv]);
HiggsMeasured=("Higgs"/.Options[StringyFNQuarksEnv]);
(*Higgsmax=Sqrt[("vumax"/.Options[StringyFNQuarksEnv])^2+("vdmax"/.Options[StringyFNQuarksEnv])^2]/(("MplinGeV"/.Options[StringyFNQuarksEnv]));
(* New Change : to a linear scaling as the EW-breaking scale is well-fixed. *)
Fitvev=If[Abs[HiggsSM-HiggsMeasured]<=(("vErr"/.Options[StringyFNQuarksEnv])/("MplinGeV"/.Options[StringyFNQuarksEnv])),
0
,
Log10[1+(Abs[HiggsSM-HiggsMeasured]/(("vErr"/.Options[StringyFNQuarksEnv])/("MplinGeV"/.Options[StringyFNQuarksEnv])))]
];*)

(*Abs[HiggsSM-HiggsMeasured]*("HiggsFitnessFactor"/.Options[StringyFNQuarksEnv]);*)
...
fitHextra=0;
If[(("vdmax"/.Options[StringyFNQuarksEnv])==("MplinGeV"/.Options[StringyFNQuarksEnv])*("Hd"/.mass)),fitHextra=fitHextra+("ExtraPenaltyforMaxHiggs"/.Options[StringyFNQuarksEnv]),fitHextra=fitHextra+0];
If[(("vumax"/.Options[StringyFNQuarksEnv])==("MplinGeV"/.Options[StringyFNQuarksEnv])*("Hu"/.mass)),fitHextra=fitHextra+("ExtraPenaltyforMaxHiggs"/.Options[StringyFNQuarksEnv]),fitHextra=fitHextra+0];


(* 3. Tangent \[Beta] contributions. *)
If[("Fitnesstan\[Beta]On"/.Options[StringyFNQuarksEnv])&&(("tan\[Beta]"/.mass)>("tan\[Beta]UpperBound")/.Options[StringyFNQuarksEnv]),
fittan\[Beta]=NormalLog[("tan\[Beta]"/.mass),(("tan\[Beta]UpperBound")/.Options[StringyFNQuarksEnv]),1000];
,
fittan\[Beta]=0];
(* Total Fitness: *)
...
(* 1. Mass Differences *)
massdexp=("md"/.Options[StringyFNQuarksEnv]);
massuexp=("mu"/.Options[StringyFNQuarksEnv]);
massdmodel=("md"/.mass);
massumodel=("mu"/.mass);
...
output1=Map[NormalLog[#[[1]],#[[2]]]&,complicatedmassd]*("fitDownFac"/.Options[StringyFNQuarksEnv]);
output2=Map[NormalLog[#[[1]],#[[2]]]&,complicatedmassu]*("fitUpFac"/.Options[StringyFNQuarksEnv]);

(* 2. Also output the indiivial CKM contributions. *)
CKMmatcomplicated=Transpose[Partition[Flatten[Join[Abs[("CKMmat"/.mass)],("CKMmat"/.Options[StringyFNQuarksEnv])]],9]];
output3=Map[NormalLog[#[[1]],#[[2]]]&,CKMmatcomplicated]*("fitCKMFac"/.Options[StringyFNQuarksEnv]);
...
\[Beta]vec=Table[\[Beta][i],{i,1,("nNonperts"/.Options[StringyFNQuarksEnv])}];
\[CapitalPhi]Chargemat=Take[Qmatrix,-("nNonperts"/.Options[StringyFNQuarksEnv])];
(* Change to downstairs rep. *)
\[CapitalPhi]Chargematlow=Map[QMatRepChange[#,("nChargeVec"/.Options[StringyFNQuarksEnv])]&,\[CapitalPhi]Chargemat];
A5anomalylow=QMatRepChange[A5anomaly,("nChargeVec"/.Options[StringyFNQuarksEnv])];
...
numSing="nSinglet"/.Options[StringyFNQuarksEnv];
If[numSing>0,
\[Phi]chargepos=Transpose[Partition[Flatten[Take[state,{12,11+2*("nSinglet"/.Options[StringyFNQuarksEnv])}]],("nSinglet"/.Options[StringyFNQuarksEnv])]];
...
replaceposrule=Join[Map[#->1&,Flatten[Position["nChargeVec"/.Options[StringyFNQuarksEnv],1]],1],
Map[#->0&,Complement[Table[i,{i,1,"nU1s"/.Options[StringyFNQuarksEnv]}],Flatten[Position["nChargeVec"/.Options[StringyFNQuarksEnv],1]]],1]];
...
If[("diffPenal"/.Options[StringyFNQuarksEnv]),
FitDiffExtra=Abs[Max[ThreeFitSecs]-Min[ThreeFitSecs]],
FitDiffExtra=0];

(* 2. Individual Differences. *)
If["indPenal"/.Options[StringyFNQuarksEnv],
fitnessQmass="FitnessQmass"/.FitQCKMsector;
fitnessCKM="FitnessCKM"/.FitQCKMsector;
QmassIndPen=Map[If[#<=0,0,#]&,(fitnessQmass-ConstantArray[("indFitMax"/.Options[StringyFNQuarksEnv]),Length[fitnessQmass]])];
QmixIndPen=Map[If[#<=0,0,#]&,(fitnessCKM-ConstantArray[("indFitMax"/.Options[StringyFNQuarksEnv]),Length[fitnessCKM]])];
...
TotalFit=("FitnessHSec"/.FitHsector)*("factorFitnessH"/.Options[StringyFNQuarksEnv])+("FitnessQMassSec"/.FitQCKMsector)*("factorFitnessQ"/.Options[StringyFNQuarksEnv])
+("FitnessQMixSec"/.FitQCKMsector)*("factorFitnessCKM"/.Options[StringyFNQuarksEnv])
+("FitnessGSSec"/.FitGSsector)*("factorFitnessGS"/.Options[StringyFNQuarksEnv])
+("FitnessNAFSec"/.FitNAFsector)*("factorFitnessNAF"/.Options[StringyFNQuarksEnv])
+("FitnessRGSec"/.FitRGSector)*("factorFitnessRG"/.Options[StringyFNQuarksEnv])
...
NewO1Vec[[Pos]]=O1VecToChange[[Pos]]+("O1CoeffVarDiff"/.Options[StringyFNQuarksEnv]);
Return[NewO1Vec]
]
...
O1DiffScale=("O1CoeffVarDiff"/.Options[StringyFNQuarksEnv]);
...
Adjoin\[Kappa]Rule=Table[("BundleModuliFields"/.Options[StringyFNQuarksEnv])[i]->\[Kappa]*("BundleModuliFields"/.Options[StringyFNQuarksEnv])[i],{i,1,"nSinglet"/.Options[StringyFNQuarksEnv],1}];
Wexpansion=Wexpansion/.Adjoin\[Kappa]Rule;
Wexpansion=Wexpansion+O[\[Kappa]]^(1+"DimOp"/.Options[StringyFNQuarksEnv]);

(* Adjoining \[Sigma] factors for \[CapitalPhi] fields. *)
Adjoin\[Sigma]Rule=Table[("KahlerEffFields"/.Options[StringyFNQuarksEnv])[i]->\[Sigma]*("KahlerEffFields"/.Options[StringyFNQuarksEnv])[i],{i,1,"nNonperts"/.Options[StringyFNQuarksEnv],1}];
Wexpansion=Wexpansion/.Adjoin\[Sigma]Rule;
Wexpansion=Wexpansion+O[\[Sigma]]^(1+"DimOpof\[CapitalPhi]"/.Options[StringyFNQuarksEnv]);
...
(* Convert list. *)
Ydn=Normal[Yd]/.{\[Kappa]->"Mpl/Mcy"/.Options[StringyFNQuarksEnv],\[Sigma]->1};
Yun=Normal[Yu]/.{\[Kappa]->"Mpl/Mcy"/.Options[StringyFNQuarksEnv],\[Sigma]->1};
...
nVec="nChargeVec"/.Options[StringyFNQuarksEnv];
fixedQBoo="fixedCharges"/.Options[StringyFNQuarksEnv];
tenFQ="tenQ"/.Options[StringyFNQuarksEnv];
fiveBarHFQ="fiveBarHiggsQ"/.Options[StringyFNQuarksEnv];
...
splittext=text/.{StringyFNQuarksEnv`BREAK->{}};
...
dimQ=11+("nSinglet"/.Options[StringyFNQuarksEnv])*2+("nNonperts"/.Options[StringyFNQuarksEnv])*("nU1s"/.Options[StringyFNQuarksEnv]);
...
countSing=Count[vars,("BundleModuliFields"/.Options[StringyFNQuarksEnv])[_Integer?Positive]];
countKahl=Count[vars,("KahlerEffFields"/.Options[StringyFNQuarksEnv])[_Integer?Positive]];
...
(*If[("ComputeKahlerOn"/.Options[StringyFNQuarksEnv]),
...
fields=Join[Table[("BundleModuliFields"/.Options[StringyFNQuarksEnv])[i],{i,1,"nSinglet"/.Options[StringyFNQuarksEnv]}],Table[("KahlerEffFields"/.Options[StringyFNQuarksEnv])[i],{i,1,"nNonperts"/.Options[StringyFNQuarksEnv]}]];
...
(If[("fixedCharges"/.Options[StringyFNQuarksEnv]),GAConvertBitlstStateVecFix[stateBitList],GAConvertBitlstStateVecwithVEVs[stateBitList]])];
,
	(* not an association *)
	If[DetectBitlist[state],
	stateBitList=state;
	stateVec=(If[("fixedCharges"/.Options[StringyFNQuarksEnv]),GAConvertBitlstStateVecFix[stateBitList],GAConvertBitlstStateVecwithVEVs[stateBitList]]);
	bitExists=True;
	,
		LengthSV=3*3+2+(2*"nSinglet"/.Options[StringyFNQuarksEnv])+("nNonperts"/.Options[StringyFNQuarksEnv])*("nU1s"/.Options[StringyFNQuarksEnv])+("nSinglet"+"nNonperts")/.Options[StringyFNQuarksEnv];
...
newfitness=-(Abs[meanfitness]+Abs[stddevfitness]*("factorFitnessO1"/.Options[StringyFNQuarksEnv])+fitnessTextureAssoc[["FitnessTextSec"]]*("factorFitnessTEX"/.Options[StringyFNQuarksEnv]));
*)
newFitness=-(Abs[oldO1Assoc[["Fitness"]]]
+Abs[O1FitTot]*("factorFitnessO1"/.Options[StringyFNQuarksEnv])
+Abs[fitnessTextureAssoc[["FitnessTextSec"]]]*("factorFitnessTEX"/.Options[StringyFNQuarksEnv]));
...
terminal=(newFitness>=("FitRange"/.Options[StringyFNQuarksEnv]));
If[bitExists,
...
(* In this step we have now used the newer modules using the Smith decomposition. *)
(* Setting to turn on what type of method we are generating the operators. *)
If[(("MethodGenOps"/.Options[StringyFNQuarksEnv])=="Solve")||(("MethodGenOps"/.Options[StringyFNQuarksEnv])=="Smith")||
(("MethodGenOps"/.Options[StringyFNQuarksEnv])=="List")||(("MethodGenOps"/.Options[StringyFNQuarksEnv])=="SolveA")||(("MethodGenOps"/.Options[StringyFNQuarksEnv])=="Optimal"),

If[("MethodGenOps"/.Options[StringyFNQuarksEnv])=="Solve",
{WIJaOps,O1coeffcounter}=AdjoinO1coeffWOps[(FindOpsforWIJawith\[Phi]VEVsQsector[state]),O1coefflist,1];
];
If[("MethodGenOps"/.Options[StringyFNQuarksEnv])=="Smith",
{WIJaOps,O1coeffcounter}=AdjoinO1coeffWOps[(FindOpsforWIJaSmithwith\[Phi]VEVsQsector[state]),O1coefflist,1];
];
If[("MethodGenOps"/.Options[StringyFNQuarksEnv])=="SolveA",
...
If[("MethodGenOps"/.Options[StringyFNQuarksEnv])=="Optimal",
If[("nSinglet"+"nNonperts")/.Options[StringyFNQuarksEnv]<=3,
{WIJaOps,O1coeffcounter}=AdjoinO1coeffWOps[FindOpsforWIJaListwith\[Phi]VEVsQsector[state],O1coefflist,1],
{WIJaOps,O1coeffcounter}=AdjoinO1coeffWOps[FindOpsforWIJaSmithwith\[Phi]VEVsQsector[state],O1coefflist,1]]
];
,
...
HdVal=("Hd"/.Qmassrules)*(("MplinGeV"/.Options[StringyFNQuarksEnv]));
HuVal=("Hu"/.Qmassrules)*(("MplinGeV"/.Options[StringyFNQuarksEnv]));
tan\[Beta]Val="tan\[Beta]"/.Qmassrules;
CKMmatVal=Abs[("CKMmat"/.Qmassrules)];
conversionvec={1,1,1}*(("MplinGeV"/.Options[StringyFNQuarksEnv]));
mdVal=("md"/.Qmassrules)*conversionvec;
muVal=("mu"/.Qmassrules)*conversionvec;
\[Phi]Vals=Table[("BundleModuliFields"/.Options[StringyFNQuarksEnv])[i],{i,1,"nSinglet"/.Options[StringyFNQuarksEnv]}]/.\[Phi]VEVsVal;
\[CapitalPhi]Vals=Table[("KahlerEffFields"/.Options[StringyFNQuarksEnv])[i],{i,1,"nNonperts"/.Options[StringyFNQuarksEnv]}]/.\[Phi]VEVsVal;
CKMcmplx="CKMmat"/.Qmassrules;
Jarlskogmeasured=Im[CKMcmplx[[1]][[2]]*CKMcmplx[[2]][[3]]*Conjugate[CKMcmplx[[1]][[3]]]*Conjugate[CKMcmplx[[2]][[2]]]];

YukdOps=Partition[Normal[Take[WIJaOps,9]],3]/.{\[Kappa]->"Mpl/Mcy"/.Options[StringyFNQuarksEnv],\[Sigma]->1};
YukuOps=Partition[Normal[Take[WIJaOps,-9]],3]/.{\[Kappa]->"Mpl/Mcy"/.Options[StringyFNQuarksEnv],\[Sigma]->1};
